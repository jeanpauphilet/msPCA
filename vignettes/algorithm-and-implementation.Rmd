...
normalization each pairwise term reads as a fraction of the total variance, and a fixed
`feasibilityTolerance` means the same thing for a covariance matrix and for the corresponding
correlation matrix. The same convention is used inside the solver, and for the
